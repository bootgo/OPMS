...
func init() {
	...
	//公告
	beego.Router("/notice/manage", &notices.ManageNoticeController{})
	beego.Router("/notice/ajax/status", &notices.AjaxStatusNoticeController{})
	beego.Router("/notice/ajax/delete", &notices.AjaxDeleteNoticeController{})
	beego.Router("/notice/edit/:id", &notices.EditNoticeController{})
	beego.Router("/notice/add", &notices.AddNoticeController{})
	...
	//知识列表
	beego.Router("/knowledgessort/list", &knowledges.ManageKnowledgesSortController{})
	beego.Router("/knowledgessort/ajax/status", &knowledges.AjaxStatusKnowledgeSortController{})
	beego.Router("/knowledgessort/edit/:id", &knowledges.EditKnowledgesSortController{})
	beego.Router("/knowledgessort/add", &knowledges.AddKnowledgeSortController{})
	beego.Router("/knowledgessort/ajax/delete", &knowledges.AjaxDeleteKnowledgesSortController{})
