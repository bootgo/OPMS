              ...
              <section id="unseen">
                <form id="permission-form">
                  <ul class="list-unstyled">
                    ...
                    <li data-pmodel="知识分享-knowledges-tasks||#" class="border">
                      <h4>知识分享</h4>
                      <ul class="list-unstyled">
                        <li>
                          <div class="form-group" data-cmodel="文档列表-knowledges||knowledge-list">文档列表：
                            <label class="checkbox-inline">
						...
						<li>
                          <div class="form-group" data-cmodel="文档分类-knowledges||knowledgessort-list"> 文档分类：
                            <label class="checkbox-inline">
                            <input type="checkbox" name="permission[]" value="knowledgessort-manage">
                            分类列表 </label>
                            <label class="checkbox-inline">
                            <input type="checkbox" name="permission[]" value="knowledgessort-add">
                            添加分类 </label>
                            <label class="checkbox-inline">
                            <input type="checkbox" name="permission[]" value="knowledgessort-edit">
                            编辑分类 </label>
							<label class="checkbox-inline">
                            <input type="checkbox" name="permission[]" value="knowledgessort-delete">
                            删除分类 </label>
                          </div>
                        </li>
                      </ul>
                    ...
                    <li data-pmodel="公告管理-notice-tasks||#" class="border">
                      <h4>公告管理</h4>
                      <ul class="list-unstyled">
                        
                        <li>
                          <div class="form-group" data-cmodel="公告-notice||notice-manage"> 公告：
                            <label class="checkbox-inline">
                      ...
                      <ul class="list-unstyled">
                        <li>
                          <div class="form-group" data-cmodel="供应商-baseinfo||vender-list">供应商：
                            ...
                            供应商列表 </label>
                            <label class="checkbox-inline">
                            <input type="checkbox" name="permission[]" value="vender-add">
                            添加供应商 </label>
                            <label class="checkbox-inline">
                            <input type="checkbox" name="permission[]" value="vender-edit">
                            编辑供应商 </label>
							<label class="checkbox-inline">
                            <input type="checkbox" name="permission[]" value="vender-delete">
                            删除供应商 </label>
                          </div>
                        </li>
						<li>
