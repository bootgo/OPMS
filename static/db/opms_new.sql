...
--
-- Current Database: `opms`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `opms` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Table structure for table `pms__customers`
--

DROP TABLE IF EXISTS `pms__customers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pms__customers` (
  `customersid` bigint(20) unsigned NOT NULL,
  `name` varchar(20) DEFAULT NULL,
  `contact` varchar(20) DEFAULT NULL,
  `address` varchar(255) DEFAULT NULL,
  `attachment` varchar(255) DEFAULT NULL,
  `created` int(10) DEFAULT NULL,
  `status` tinyint(1) DEFAULT '1' COMMENT '1正常2禁用3待评估4洽谈中5不可用',
  `note` varchar(255) DEFAULT NULL,
  `phone` varchar(11) DEFAULT NULL,
  `tel` varchar(11) DEFAULT NULL,
  `qq` varchar(11) DEFAULT NULL,
  `email` varchar(11) DEFAULT NULL,
  `wechat` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`customersid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pms__customers`
--

LOCK TABLES `pms__customers` WRITE;
/*!40000 ALTER TABLE `pms__customers` DISABLE KEYS */;
/*!40000 ALTER TABLE `pms__customers` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pms_albums` VALUES (1468934759849234932,1461312703628858832,'美丽的背后','/static/uploadfile/2016-9/28/d1bb6059a54a832f8542a9389d5ffcd3.jpg','','我想知道相片背后的故事',1475046528,17,1,2,1);
...
INSERT INTO `pms_albums_laud` VALUES (9026951792562176,1461312703628858832,1468934759849234932,1476955081,1),(9305430773731328,1468140265954907628,1468934759849234932,1477021475,1);
...
--
-- Dumping data for table `pms_checkworks`
--

LOCK TABLES `pms_checkworks` WRITE;
/*!40000 ALTER TABLE `pms_checkworks` DISABLE KEYS */;
INSERT INTO `pms_checkworks` VALUES (8568693101432832,1461312703628858832,'10:57:03',2,'127.0.0.1',1476845823),(8568702534422528,1461312703628858832,'10:57:05',3,'127.0.0.1',1476845825),(8906461258190848,1461312703628858832,'09:19:14',2,'127.0.0.1',1476926353),(9335379463245824,1461312703628858832,'13:43:36',2,'127.0.0.1',1477028615),(9358014863642624,1461312703628858832,'08:00:03',3,'127.0.0.1',1477034012);
/*!40000 ALTER TABLE `pms_checkworks` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `pms_customers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `pms_customers` WRITE;
/*!40000 ALTER TABLE `pms_customers` DISABLE KEYS */;
INSERT INTO `pms_customers` VALUES (48516104527548416,'测试客户','测试联系人','测试地址','',1486370028,1,'dfsa','17898765432','','','','');
/*!40000 ALTER TABLE `pms_customers` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pms_knowledges_comment` VALUES (9025311345741824,1467191338628906628,1468921601280784732,'我以前就是做PHP的',1476954689,1),(9273364971524096,1467191338628906628,1468921601280784732,'lockPHP',1477013830,1),(9298587166969856,1468140265954907628,1468921601280784732,'今天的天气不错',1477019843,1);
...
INSERT INTO `pms_leaves` VALUES (9341180651245568,1461312703628858832,3,1476979200,1477238400,1.5,'我出去玩','',0,2,'1467191338628906628,1468140265954907628',1477029999,1477029999),(9341755161841664,1461312703628858832,8,1477238400,1477497600,3,'埼魂牵梦萦','',0,2,'1467191338628906628',1477030135,1477030135),(9343094470217728,1461312703628858832,4,1477584000,1477584000,1,'魂牵梦萦埼','',0,1,'1468140265954907628,1467191338628906628',1477030455,1477030455),(9345827742945280,1461312703628858832,3,1476979200,1476979200,1,'魂牵梦萦城标魂牵梦萦','',2,2,'1468140265954907628',1477031106,1477031106),(1468485329884714828,1467191338628906628,3,1474588800,1474934400,2,'出去走一走，看看大世界的美丽~','',1,2,'1468140265954907628,1461312703628858832',1474597098,1474597117),(1468486881268841232,1467191338628906628,4,1474588800,1474243200,1,'前段时间加班太久，想休息一下','',2,2,'1468140265954907628,1461312703628858832',1474598650,1474598650),(1468499570776805828,1461312703628858832,4,1474588800,1474675200,1,'大法师魂牵梦萦地城标的撒范德萨防盗防','',1,2,'1468140265954907628,1467191338628906628',1474611339,1474611339),(1469093116260676528,1461312703628858832,3,1475164800,1475251200,1,'魂牵梦萦','',1,2,'1468140265954907628',1475204885,1475204885);
...
INSERT INTO `pms_leaves_approver` VALUES (9341180898709504,9341180651245568,1467191338628906628,'',0,1477029999,1477029999),(9341181112619008,9341180651245568,1468140265954907628,'',0,1477029999,1477029999),(9341755405111296,9341755161841664,1467191338628906628,'',0,1477030136,1477030136),(9343094814150656,9343094470217728,1468140265954907628,'',0,1477030455,1477030455),(9343095434907648,9343094470217728,1467191338628906628,'',0,1477030455,1477030455),(9345827982020608,9345827742945280,1468140265954907628,'最近项目急，等下一次。',2,1477031107,1477031527),(1468485329945851032,1468485329884714828,1468140265954907628,'让你爽一段时间吧~',1,1474597098,1474597890),(1468485329970682132,1468485329884714828,1461312703628858832,'好的，可以~',1,1474597098,1474597954),(1468486881315872732,1468486881268841232,1468140265954907628,'明天有个紧急项目处理完了，再调休吧',2,1474598650,1474600405),(1468486881388411732,1468486881268841232,1461312703628858832,'前审批人拒绝，后面审批人默认拒绝',2,1474598650,1474600405),(1468499570822373232,1468499570776805828,1468140265954907628,'可以，不容易~',1,1474611339,1474618252),(1468499570879828328,1468499570776805828,1467191338628906628,'OK,没有问题',1,1474611339,1474618270),(1469093116306650732,1469093116260676528,1468140265954907628,'可以',1,1475204885,1477017529);
...
LOCK TABLES `pms_messages` WRITE;
/*!40000 ALTER TABLE `pms_messages` DISABLE KEYS */;
INSERT INTO `pms_messages` VALUES (9298587246661632,1468140265954907628,1461312703628858832,1,11,'lockPHP框架升级2.0','/knowledge/1468921601280784732',2,1477019843),(9305430811480064,1468140265954907628,1461312703628858832,2,22,'美丽的背后','/album/1468934759849234932',2,1477021475),(9305470346989568,1468140265954907628,1461312703628858832,1,12,'美丽的背后','/album/1468934759849234932',2,1477021485),(9339159604891648,1467191338628906628,1461312703628858832,3,34,'同意','/businesstrip/approval/1468842643441590032',2,1477029517),(9341755593854976,1461312703628858832,1467191338628906628,4,31,'去审批处理','/leave/approval/9341755161841664',2,1477030136),(9343095145500672,1461312703628858832,1468140265954907628,4,31,'去审批处理','/leave/approval/9343094470217728',2,1477030455),(9343095707537408,1461312703628858832,1467191338628906628,4,31,'去审批处理','/leave/approval/9343094470217728',1,1477030455),(9346109554036736,1461312703628858832,1468140265954907628,4,31,'去审批处理','/leave/approval/9345827742945280',2,1477031174),(9347589832970240,1468140265954907628,1461312703628858832,3,31,'拒绝','/leave/approval/9345827742945280',2,1477031527),(9350488906534912,1461312703628858832,1468140265954907628,4,32,'去审批处理','/overtime/approval/9350441984856064',2,1477032218),(9350600059785216,1468140265954907628,1461312703628858832,3,32,'拒绝','/overtime/approval/9350441984856064',2,1477032244);
/*!40000 ALTER TABLE `pms_messages` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pms_overtimes` VALUES (9350441984856064,1461312703628858832,1477032000,1477062000,6,2,2,'城标埼韦尔奇',2,2,'1468140265954907628',1477032207,1477032207),(1469101768980362328,1461312703628858832,1475213700,1475717100,81,1,2,'魂牵梦萦',1,2,'1469024587469707428',1475213537,1475213717);
...
INSERT INTO `pms_overtimes_approver` VALUES (9350442173599744,9350441984856064,1468140265954907628,'今天是周五，不用加班~',2,1477032207,1477032244),(1469101769037534028,1469101768980362328,1469024587469707428,'可以',1,1475213537,1475213870);
...
INSERT INTO `pms_users_profile` VALUES (1461312703628858832,'李白',1,'1985-12-12','test@163.com','milu365','49732343','13754396432','021-3432423','九新公路华西办公楼7楼','zfancy','137245613126',1462290228639093428,1462292041515367932,58,'',1486369093),(1467191338628906628,'张三',1,'1985-12-12','test@test.com','zs-milu365','903561702','13524512531','021-84122521','九新公路','lock','135245132623',1462290199274575028,1462292041515367932,14,'',1477028450),(1468140265954907628,'李四',1,'1994-08-11','cto@nahehuo.com','zs-milu365','903561702','13524396586','021-84122521','九新公路华西办公楼','lock','135245132623',1462290127694985332,1462292053049130632,9,'127.0.0.1',1477031153),(1468915433602979028,'朱笑天',1,'1992-09-10','test@test.coma','zs-milu365','903561702','13524512531','021-84122521','外滩一号','lock','135245132623',1462290199274575028,1462292041515367932,2,'127.0.0.1',1475051104),(1469024587469707428,'李浩',1,'1997-09-06','test@test.com','ls-milu365','903561702','13521234231','021-84122521','外滩一号','李呀','135245132623',1462290228639093428,1462292006260420932,3,'127.0.0.1',1475213790);
...
-- Dump completed on 2017-02-07  1:03:02
-- MySQL dump 10.13  Distrib 5.6.35, for Linux (x86_64)
--
-- Host: localhost    Database: opms
-- ------------------------------------------------------
...
-- Dump completed on 2017-02-07  1:04:33
-- MySQL dump 10.13  Distrib 5.6.35, for Linux (x86_64)
--
-- Host: localhost    Database: opms
-- ------------------------------------------------------
...
-- Dump completed on 2017-02-07  1:04:51
